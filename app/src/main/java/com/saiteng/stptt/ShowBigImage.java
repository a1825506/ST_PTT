...
import com.saiteng.picHelper.PhotoView;
import com.saiteng.task.LoadLocalBigImgTask;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (uri != null && new File(uri.getPath()).exists()) {
			...
			if (bitmap == null) {
				LoadLocalBigImgTask task = new LoadLocalBigImgTask(this, uri.getPath(), image, loadLocalPb, 640,
						960);
